    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-lg transition p-5">
      <div className="flex flex-col gap-3">
        ...
        <div className="mt-2 flex flex-wrap gap-3">
          ...
          {/* Delete button only rendered if passed in by parent and user owns it */}
          {/* (logic unchanged; this block simply won’t render if onDelete is undefined) */}
          {/* currentUser is not referenced here per your original signature for this renderer */}
        </div>
      </div>
    </div>
  );
